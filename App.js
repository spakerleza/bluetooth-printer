        ...
        return (
            <ScrollView style={styles.container}>
                ...
                <View style={{ flex: 1,marginTop: 30, marginBottom: 30, }} >
                    <Text style={styles.title, { textAlign: "center"  }}>Enter and print costomer information</Text>
                </View>
                ...
                <View style={styles.btn}>
                    <Button disabled={this.state.loading || this.state.boundAddress.length <= 0}
                        ...
                        try {
                            ...
                            const res = await axios.get("https://astutefinance.co/server/Register/request", {
